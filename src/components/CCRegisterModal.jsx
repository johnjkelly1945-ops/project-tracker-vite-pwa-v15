...
export default function CCRegisterModal({ taskId, taskTitle, segmentId, onClose, onOpenCCEvent, isPM, readOnly = false, constitutionalEngagement }) {
