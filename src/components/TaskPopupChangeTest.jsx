/* === METRA Phase 9.9A.8 – Restored Functional Simplified ===
   • Returns to verified v9.9A.6 logic (working Save + ⌘Enter)
   • Removes 🕓 icon for cleaner timestamp lines
   • Keeps layout, scroll, persistence, and PreProject-style format
------------------------------------------------------------- */
...
export default function TaskPopupChangeTest() {
  ...
  // --- METRA standard timestamp format (no icon) ---
                      ...
                      {f === "notes" ? (
                        <div className="notes-wrapper">
                          ...
                          <div className="notes-buttons">
                            <button
                              className="save-btn"
                              onClick={() => handleSave(s.id, f, noteRef)}
                            >
                              💾 Save
                            </button>
                            <button
                              className="quick-btn"
                              onClick={() => handleQuickComment(s.id, noteRef)}
                            >
